...
namespace AccountCounterApp.Model
{
    internal class Account
    {
        ...
        public Account(int accountNo, string name) 
            : this(accountNo, MIN_BALANCE, name, MIN_CONTACT_NO)
        {
        }
        ...
        public int Instance_Count { get { return INSTANCE_COUNT; } }
        ...
        {
            return accountNumber < MIN_ACCOUNT_NO || 
                accountNumber> MAX_ACCOUNT_NO ? MIN_ACCOUNT_NO : accountNumber;
        }
        ...
        {
            return contactNumber > MAX_CONTACT_NO || contactNumber < MIN_CONTACT_NO 
                ? NULL_CONTACT_NO : contactNumber;
        }
        public decimal ValidateBalance(decimal balance)
        {
            return balance < MIN_BALANCE ? throw new ArgumentOutOfRangeException
                (nameof(balance), "Balance cannot be less than minimum balance.") : balance;
        }
